...
////////////////////
// Modules
const static Int_t   V1190_TDC_CH  = 64;  
const static Int_t   V792_QDC_CH   = 32;
const static Int_t   V785N_ADC_CH  = 16;
const static Int_t   V785_ADC_CH   = 32;
...
const static Int_t   NSiPM    = 32;   // For setup of Phase one, serial connection of SiPMs
...
//const static Int_t   ENABLED_TDC_CH   = 64;   
...
const static Double_t SiW     = 3.81;  // Ionization energy of Silicon @ 77 Kelvin
...
/////////////////////
// File directories:
const static TString  WORK_PATH  = "/Users/hexishi/wrk/VIP2";
...
const static TString  BIN_PATH   = DATA_PATH + "/bin";
//const static TString  BIN_PATH   = "/Volumes/sdpc1/wrk/shx/vip2/data/SMI";
