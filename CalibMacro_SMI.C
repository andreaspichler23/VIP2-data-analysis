...
void CalibMacro_SMI( ID nSDD,  ID nPADC,  TString rootf, TString source, TString place )
{
    ...
    datafile.open(WORK_PATH + "/calibrationlist/15files-SMI.txt",ios::app);
    TString fileNamePart = rootf(17,2); // change here!! 
